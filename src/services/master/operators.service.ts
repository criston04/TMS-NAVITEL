/**
 * @fileoverview Servicio para gestión de Operadores Logísticos
 * @module services/master/operators
 * @description Implementa operaciones CRUD para operadores logísticos.
 * @author TMS-NAVITEL
 * @version 1.0.0
 */
