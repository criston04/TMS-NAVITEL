...
const KPI_CONFIGS: KPIConfig[] = [
  ...
  },
  {
    ...
    icon: AlertTriangle,
    format: (v) => v.toString(),
    color: (v) => getThresholdColor(v, { high: 5, medium: 0 }, { high: 'text-red-500', medium: 'text-amber-500', low: 'text-green-500' }),
    tooltip: 'Órdenes con conflictos o retrasos',
  },
  {
    ...
    tooltip: 'Porcentaje de utilización de la flota',
    showProgress: true,
    progressMax: 100,
  },
  {
